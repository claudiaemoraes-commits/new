...
if desconto_solicitado == bronze:
    ...
    print("O valor do desconto é: {}".format(desconto_solicitado))
    print("O valor final da compra é: {}".format(valor_compra - desconto_solicitado))
    ...
    print("Percentual de desconto não reconhecido, o valor final da compra é: {}".format(valor_compra))
